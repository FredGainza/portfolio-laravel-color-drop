...
/********** TRIANGLE **********/
function triangle(id, colorC = 0, color = 0) {
    var canvas = document.getElementById(id);
    ...
    ctx.beginPath();
    ctx.lineWidth = "6"; // Épaisseur du trait
    ctx.moveTo(0, -h / 2);
    ...
    ctx.closePath();
    if (color != 0) {
        ctx.fill(); // Enregistrement du fond
    }

}
    // w = canvas.width;
    // h = canvas.height;
    // ctx.beginPath(); // Initialisation du dessin
    // ctx.translate(canvas.width / 2); // Permet de placer le point de départ du dessin à la demi-largeur du cadre appelé "Canvas".
    // if (colorC != 0) {
    //     ctx.strokeStyle = colorC; // Couleur du trait
    // }
    // if (color != 0) {
    //     ctx.fillStyle = color; // Couleur du fond
    // }
    // ctx.lineWidth = "8"; // Épaisseur du trait
    // ctx.moveTo(0, 0); // Départ du 1er trait
    // ctx.rotate(-Math.PI / 6); // Permet d'orienter le premier côté à 30° - sens anti-horaire ou trigonométrique - par rapport à la verticale.
    // ctx.lineTo(0, h); // Arrivée du 1er trait
    // ctx.rotate(Math.PI / 3); // Permet d'exercer une rotation du 2e côté de 60° - sens horaire - par rapport au premier.
    // ctx.lineTo(0, h); // Arrivée du 2e côté
    // ctx.rotate(Math.PI); // Rotation
    // ctx.lineTo(0, h); // Arrivée du 3e côté
    // if (colorC != 0) {
    //     ctx.stroke(); //Enregistrement du tracé
    // }
...
/********** CERCLE **********/
function rectangle(id, x, y, width, height, colorC = 0, color = 0) {
    var canvas = document.getElementById(id);
    var context = canvas.getContext("2d");
    context.beginPath(); // Initialisation du dessin
    if (colorC != 0) {
    ...
    context.lineWidth = "8"; // Epaisseur du trait
    context.rect(x, y, width, height); // Tracé de la forme (coordonnées de l'origine x, y, longueur et largeur)
    if (color != 0) {
        context.fillStyle = color; // Couleur du fond
    }
    if (colorC != 0) {
    ...
    */
    ...
    $('.ecouteurJeu').click(function () {
        ...
        if($nbClick === 1){
            ...
            $('#containerCible').css("background-image", "url('../img/tab-f.png')");
            // $('#selectPlayer').fadeOut(200);
            // $('#nameSelect').fadeOut(200);
        ...
        if($nbClick< 5){
            ...
            */
            ...
            for ($i = 0; $i <$nbCarres; $i++) {
                ...
                $('#cible').append('<canvas id="carre_'+$i+'" width="100" height="100" style ="width :16% ; height : auto ;" class="draggable mx-1"></canvas>'); // DIV CARRES CIBLES
            }
        ...
        */
        ...
        if ($nbClick === 5) {
            ...
            $formesCibles = [];
            $formesCibles[0] = '<canvas id="formeCible0" width="100" height="100" style ="width :20% ; height : auto ;" class="draggable mx-3"></canvas><br>';
            $formesCibles[1] = '<canvas id="formeCible1" width="110" height="120" style ="width :20% ; height : auto ;" class="draggable mx-3"></canvas><br>';
            $formesCibles[2] = '<canvas id="formeCible2" width="100" height="100" style ="width :20% ; height : auto ;" class="draggable mx-3"></canvas><br>';
            ...
            $formes = [];
            $formes[0] = '<canvas id="forme0" width="100" height="100" style ="width :11% ; height : auto ;" class="bg-darky2 mx-3"></canvas><br>';
            $formes[1] = '<canvas id="forme1" width="110" height="120" style ="width :11% ; height : auto ;" class="bg-darky2 mx-3"></canvas><br>';
            $formes[2] = '<canvas id="forme2" width="100" height="100" style ="width :11% ; height : auto ;" class="bg-darky2 mx-3"></canvas><br>';
        ...
        // LEVEL 6 : 4 FIGURES GEOMETRIQUES
            ...
            $formesCibles = [];
            $formesCibles[0] = '<canvas id="formeCible0" width="110" height="110" style ="width :20% ; height : auto ;" class="draggable mx-2"></canvas><br>';
            $formesCibles[1] = '<canvas id="formeCible1" width="160" height="100" style ="width :20% ; height : auto ;" class="draggable mx-2"></canvas><br>';
            $formesCibles[2] = '<canvas id="formeCible2" width="110" height="110" style ="width :20% ; height : auto ;" class="draggable mx-2"></canvas><br>';
            $formesCibles[3] = '<canvas id="formeCible3" width="110" height="110" style ="width :20% ; height : auto ;" class="draggable mx-2"></canvas><br>';
            ...
            rectangle("formeCible1", 10, 25, 140, 70, "black", couleursNiv4[1]);
            cercle("formeCible2", "black", couleursNiv4[2]);
            triangle("formeCible3", "black", couleursNiv4[3]);

            $formes = [];
            $formes[0] = '<canvas id="forme0" width="110" height="110" style ="width :11% ; height : auto ;" class="bg-darky2 mx-3"></canvas><br>';
            $formes[1] = '<canvas id="forme1" width="160" height="100" style ="width :11% ; height : auto ;" class="bg-darky2 mx-3"></canvas><br>';
            $formes[2] = '<canvas id="forme2" width="110" height="110" style ="width :11% ; height : auto ;" class="bg-darky2 mx-3"></canvas><br>';
            $formes[3] = '<canvas id="forme3" width="110" height="110" style ="width :11% ; height : auto ;" class="bg-darky2 mx-3"></canvas><br>';
            ...
            rectangle("forme1", 10, 25, 140, 70, "black", couleursNiv4[1]);            cercle("forme2", "black", couleursNiv4[2]);
        ...
        // LEVEL 7 : 5 FIGURES GEOMETRIQUES
            ...
            $formesCibles = [];
            $formesCibles[0] = '<canvas id="formeCible0" width="110" height="110" style ="width :20% ; height : auto ;" class="draggable mx-3"></canvas><br>';
            $formesCibles[1] = '<canvas id="formeCible1" width="160" height="100" style ="width :20% ; height : auto ;" class="draggable mx-3"></canvas><br>';
            $formesCibles[2] = '<canvas id="formeCible2" width="110" height="110" style ="width :20% ; height : auto ;" class="draggable mx-3"></canvas><br>';
            $formesCibles[3] = '<canvas id="formeCible3" width="110" height="110" style ="width :20% ; height : auto ;" class="draggable mx-3"></canvas><br>';
            $formesCibles[4] = '<canvas id="formeCible4" width="110" height="110" style ="width :20% ; height : auto ;" class="draggable mx-3"></canvas><br>';
            ...
            rectangle("formeCible1", 10, 25, 140, 70, "black", couleursNiv5[1]);
            ...
            $formes = [];
            $formes[0] = '<canvas id="forme0" width="110" height="110" style ="width :11% ; height : auto ;" class="bg-darky2 my-1 mx-3"></canvas><br>';
            $formes[1] = '<canvas id="forme1" width="160" height="100" style ="width :11% ; height : auto ;" class="bg-darky2 my-1 mx-3"></canvas><br>';
            $formes[2] = '<canvas id="forme2" width="110" height="110" style ="width :11% ; height : auto ;" class="bg-darky2 my-1 mx-3"></canvas><br>';
            $formes[3] = '<canvas id="forme3" width="110" height="110" style ="width :11% ; height : auto ;" class="bg-darky2 my-1 mx-3"></canvas><br>';
            $formes[4] = '<canvas id="forme4" width="110" height="110" style ="width :11% ; height : auto ;" class="bg-darky2 my-1 mx-3"></canvas><br>';
            ...
            rectangle("forme1", 10, 25, 140, 70, "black", couleursNiv5[1]);
        ...
        // LEVEL 8 : 6 FIGURES GEOMETRIQUES
            ...
            $formesCibles[1] = '<canvas id="formeCible1" width="160" height="100" style ="width :20% ; height : auto ;" class="draggable mx-3"></canvas><br>';
            $formesCibles[2] = '<canvas id="formeCible2" width="110" height="110" style ="width :20% ; height : auto ;" class="draggable mx-3"></canvas><br>';
            $formesCibles[3] = '<canvas id="formeCible3" width="100" height="100" style ="width :20% ; height : auto ;" class="draggable mx-3"></canvas><br>';
            $formesCibles[4] = '<canvas id="formeCible4" width="110" height="110" style ="width :20% ; height : auto ;" class="draggable mx-3"></canvas><br>';
            $formesCibles[5] = '<canvas id="formeCible5" width="110" height="110" style ="width :20% ; height : auto ;" class="draggable mx-3"></canvas><br>';
            ...
            rectangle("formeCible1", 10, 25, 140, 70, "black", couleursNiv6[1]);
            ...
            $formes[1] = '<canvas id="forme1" width="160" height="100" style ="width :11% ; height : auto ;" class="bg-darky2 mx-3"></canvas><br>';
            $formes[2] = '<canvas id="forme2" width="110" height="110" style ="width :11% ; height : auto ;" class="bg-darky2 mx-3"></canvas><br>';
            $formes[3] = '<canvas id="forme3" width="100" height="100" style ="width :11% ; height : auto ;" class="bg-darky2 mx-3"></canvas><br>';
            $formes[4] = '<canvas id="forme4" width="110" height="110" style ="width :11% ; height : auto ;" class="bg-darky2 mx-3"></canvas><br>';
            $formes[5] = '<canvas id="forme5" width="110" height="110" style ="width :11% ; height : auto ;" class="bg-darky2 mx-3"></canvas><br>';
            ...
            rectangle("forme1", 10, 25, 140, 70, "black", couleursNiv6[1]);
                        ...
                        if ($nb == $nbFruits) {
                            ...
                            if($nbClick == 10){
                                ...
                                if ( $icon.attr('src') == 'img/audio/music-on.png' && $bruit.attr('src') == 'img/audio/bruit-on.png'){
                                    ...
                                    // let relance = setTimeout(function() {
                                    //     myMusic.play();
                                    // }, 12000);
                                }
