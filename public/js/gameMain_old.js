    ...
    $('.ecouteurJeu').click(function () {
        ...
        if($nbClick< 5){
            ...
            */
            ...
            for ($i = 0; $i <$nbCarres; $i++) {
                ...
                $('#cible').append('<canvas id="carre_'+$i+'" width="100" height="100" style ="width :16% ; height : auto ;" class="draggable mx-2 mb-2"></canvas>'); // DIV CARRES CIBLES
            }
        ...
        */
        ...
        if ($nbClick === 5) {
            ...
            formesCible();
            // $formesCibles[0] = '<canvas id="formeCible0" width="100" height="100" style ="width :'+$d+' ; height : auto ;" class="draggable mx-3 mb-1"></canvas><br>';
            // $formesCibles[1] = '<canvas id="formeCible1" width="110" height="120" style ="width :'+$d+' ; height : auto ;" class="draggable mx-3 mb-1"></canvas><br>';
            // $formesCibles[2] = '<canvas id="formeCible2" width="100" height="100" style ="width :'+$d+' ; height : auto ;" class="draggable mx-3 mb-1"></canvas><br>';
            ...
            formesOrigine();
            // $formes[0] = '<canvas id="forme0" width="100" height="100" style ="width :9% ; height : auto ;" class="bg-darky2 mx-3"></canvas><br>';
            // $formes[1] = '<canvas id="forme1" width="110" height="120" style ="width :9% ; height : auto ;" class="bg-darky2 mx-3"></canvas><br>';
            // $formes[2] = '<canvas id="forme2" width="100" height="100" style ="width :9% ; height : auto ;" class="bg-darky2 mx-3"></canvas><br>';
        ...
        // LEVEL 6 : 4 FIGURES GEOMETRIQUES
            ...
            $d=0;
            $difficulte =="fit" ? $d = "17%" : "16%";

            formesCible();
            // $formesCibles = [];
            // $formesCibles[0] = '<canvas id="formeCible0" width="110" height="110" style ="width :'+$d+' ; height : auto ;" class="draggable mx-2 mb-1"></canvas><br>';
            // $formesCibles[1] = '<canvas id="formeCible1" width="110" height="110" style ="width :'+$d+' ; height : auto ;" class="draggable mx-2 mb-1"></canvas><br>';
            // $formesCibles[2] = '<canvas id="formeCible2" width="110" height="110" style ="width :'+$d+' ; height : auto ;" class="draggable mx-2 mb-1"></canvas><br>';
            // $formesCibles[3] = '<canvas id="formeCible3" width="110" height="110" style ="width :'+$d+' ; height : auto ;" class="draggable mx-2 mb-1"></canvas><br>';
            ...
            etoile("formeCible1", 55, 60, 5, 50, 25, "black", couleursNiv4[1]);
            cercle("formeCible2", "black", couleursNiv4[2]);
            triangle("formeCible3", "black", couleursNiv4[3]);

            formesOrigine();
            // $formes = [];
            // $formes[0] = '<canvas id="forme0" width="110" height="110" style ="width :9% ; height : auto ;" class="bg-darky2 mx-3"></canvas><br>';
            // $formes[1] = '<canvas id="forme1" width="110" height="110" style ="width :9% ; height : auto ;" class="bg-darky2 mx-3"></canvas><br>';
            // $formes[2] = '<canvas id="forme2" width="110" height="110" style ="width :9% ; height : auto ;" class="bg-darky2 mx-3"></canvas><br>';
            // $formes[3] = '<canvas id="forme3" width="110" height="110" style ="width :9% ; height : auto ;" class="bg-darky2 mx-3"></canvas><br>';
            ...
            etoile("forme1", 55, 60, 5, 50, 25, "black", couleursNiv4[1]);
        ...
        // LEVEL 7 : 5 FIGURES GEOMETRIQUES
            ...
            formesCible();
            // $formesCibles = [];
            // $formesCibles[0] = '<canvas id="formeCible0" width="110" height="110" style ="width :'+$d+' ; height : auto ;" class="draggable mx-3 mb-1"></canvas><br>';
            // $formesCibles[1] = '<canvas id="formeCible1" width="110" height="110" style ="width :'+$d+' ; height : auto ;" class="draggable mx-3 mb-1"></canvas><br>';
            // $formesCibles[2] = '<canvas id="formeCible2" width="110" height="110" style ="width :'+$d+' ; height : auto ;" class="draggable mx-3 mb-1"></canvas><br>';
            // $formesCibles[3] = '<canvas id="formeCible3" width="110" height="110" style ="width :'+$d+' ; height : auto ;" class="draggable mx-3 mb-1"></canvas><br>';
            // $formesCibles[4] = '<canvas id="formeCible4" width="110" height="110" style ="width :'+$d+' ; height : auto ;" class="draggable mx-3 mb-1"></canvas><br>';
            ...
            etoile("formeCible1", 55, 60, 5, 50, 25, "black", couleursNiv5[1]);
            ...
            formesOrigine();
            // $formes = [];
            // $formes[0] = '<canvas id="forme0" width="110" height="110" style ="width :9% ; height : auto ;" class="bg-darky2 my-1 mx-3"></canvas><br>';
            // $formes[1] = '<canvas id="forme1" width="110" height="110" style ="width :9% ; height : auto ;" class="bg-darky2 my-1 mx-3"></canvas><br>';
            // $formes[2] = '<canvas id="forme2" width="110" height="110" style ="width :9% ; height : auto ;" class="bg-darky2 my-1 mx-3"></canvas><br>';
            // $formes[3] = '<canvas id="forme3" width="110" height="110" style ="width :9% ; height : auto ;" class="bg-darky2 my-1 mx-3"></canvas><br>';
            // $formes[4] = '<canvas id="forme4" width="110" height="110" style ="width :9% ; height : auto ;" class="bg-darky2 my-1 mx-3"></canvas><br>';
            ...
            etoile("forme1", 55, 60, 5, 50, 25, "black", couleursNiv5[1]);
        ...
        // LEVEL 8 : 6 FIGURES GEOMETRIQUES
            ...
            // $formesCibles[1] = '<canvas id="formeCible1" width="110" height="110" style ="width :'+$d+' ; height : auto ;" class="draggable mx-3 mb-1"></canvas><br>';
            // $formesCibles[2] = '<canvas id="formeCible2" width="110" height="110" style ="width :'+$d+' ; height : auto ;" class="draggable mx-3 mb-1"></canvas><br>';
            // $formesCibles[3] = '<canvas id="formeCible3" width="100" height="100" style ="width :'+$d+' ; height : auto ;" class="draggable mx-3 mb-1"></canvas><br>';
            // $formesCibles[4] = '<canvas id="formeCible4" width="110" height="110" style ="width :'+$d+' ; height : auto ;" class="draggable mx-3 mb-1"></canvas><br>';
            // $formesCibles[5] = '<canvas id="formeCible5" width="110" height="110" style ="width :'+$d+' ; height : auto ;" class="draggable mx-3 mb-1"></canvas><br>';
            ...
            etoile("formeCible1", 55, 60, 5, 50, 25, "black", couleursNiv6[1]);
            ...
            // $formes[1] = '<canvas id="forme1" width="110" height="110" style ="width :9% ; height : auto ;" class="bg-darky2 mx-3"></canvas><br>';
            // $formes[2] = '<canvas id="forme2" width="110" height="110" style ="width :9% ; height : auto ;" class="bg-darky2 mx-3"></canvas><br>';
            // $formes[3] = '<canvas id="forme3" width="100" height="100" style ="width :9% ; height : auto ;" class="bg-darky2 mx-3"></canvas><br>';
            // $formes[4] = '<canvas id="forme4" width="110" height="110" style ="width :9% ; height : auto ;" class="bg-darky2 mx-3"></canvas><br>';
            // $formes[5] = '<canvas id="forme5" width="110" height="110" style ="width :9% ; height : auto ;" class="bg-darky2 mx-3"></canvas><br>';
            ...
            etoile("forme1", 55, 60, 5, 50, 25, "black", couleursNiv6[1]);
