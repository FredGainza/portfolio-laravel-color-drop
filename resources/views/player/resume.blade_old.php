        ...
        <div class="container">
            ...
            <div class="row bg-dark text-white">
                <div class="col-sm-4 mt-3 pb-3">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="#myChart1">Données synthétisées par partie</a></li>
                        <li><a href="#myChart2">Ensemble des données par niveaux</a></li>
                        <li><a href="#myChart3">Données synthétisées par thème</a></li>
                    </ul>
                </div>

                <div class="col-sm-8 my-auto">
                    <canvas id="myChart1" width="400" height="200" class="visibility1"></canvas>
                </div>
                <div class="col-sm-8 my-auto">
                    <canvas id="myChart2" width="400" height="200" class="visibility2"></canvas>
                </div>
                <div class="col-sm-8 my-auto">
                    <canvas id="myChart3" width="400" height="200" class="visibility3"></canvas>
                </div>
            </div>
        </div>
    </main>
